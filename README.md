...
- **Telegram bot** — button-driven wizard flows to view your day, manage tasks, and plan timeboxes from your phone
- **REST API** — HTTP endpoints with Bearer token auth for external integrations
...
- **[Telegram Bot](docs/telegram.md)** — setup, button-driven wizard flows
...
| `API_TOKEN` | For API | — | Bearer token for REST API authentication |
| `API_PORT` | No | `34136` | REST API port |
