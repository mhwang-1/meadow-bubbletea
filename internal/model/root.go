...
func (m RootModel) shortcutBarText() string {
	...
	case m.view == ViewDay && m.mode == ModePlan:
		return "↑↓ navigate · n new · Enter edit · r reserve · / assign · d delete · a archive · U unarchive · - notes · t today · Tab execute · Shift+Tab week · q quit"
